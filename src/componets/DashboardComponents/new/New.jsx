...
function New({ title }) {
  ...
  return (
    <div className="new">
      <SideBar onSignupClick={handleSignupClick} onRoomClick={handleRoomClick} onAddRoomClick={() => {setShowRoom(false); setShowSignup(false)}} />
      <div className="newcontainer">
        ...
        {(showRoom || showSignup) && <div className="listContainer">
          <div className='auths'>
            {showSignup && <Signup />}
